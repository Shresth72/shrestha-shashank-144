...
const Footer: React.FC = () => {
  ...
  return (
    ...
    <footer className="text-white relative bottom-0 text-sm translate-y-[100vh] py-4 w-full bg-black">
      <div className="h-[1px] w-[100vw] absolute -top-12 -left-14 bg-gray-900"></div>
      <div className="container mx-auto flex flex-col md:flex-row md:items-start justify-between items-center">
        <div
          className="quote w-full md:w-[36%] text-center md:text-left text-2xl md:text-3xl mb-3 md:mb-0"
          style={{ fontFamily: "Afrah" }}
        >
          <p>Crafting pixels, shaping code; where development meets design</p>
        </div>
        <div className="text-center md:text-left details flex flex-col items-center md:items-end">
          <h2 className="mb-2 text-lg hidden md:flex" style={{ fontFamily: "Afrah" }}>
            Delhi, India
          </h2>
          <p className="underline transition-all duration-500 text-gray-600 hover:text-white">
            shashankshrestha539@gmail.com
          </p>
        </div>
        <div className="social flex flex-col items-center px-8 md:px-0 md:items-end mt-4 md:mt-0 gap-4">
          <h2 className="mb-0 md:mb-3" style={{ fontFamily: "Afrah" }}>
            Follow Me
          </h2>
          <div className="flex justify-between gap-2">
            <a
